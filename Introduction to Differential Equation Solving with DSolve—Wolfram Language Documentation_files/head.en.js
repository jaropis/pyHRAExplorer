...
// disable back-forward cache; forces Safari and Firefox to reload the page when the browser's back/forward buttons are used
...
if ('ontouchstart' in window || window.DocumentTouch && document instanceof DocumentTouch || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0) _html.className += ' touch-enabled';
